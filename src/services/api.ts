...
export async function processPaper(file: File | string): Promise<ProcessPaperResult> {
...
export async function generateSimilarQuestions(questionText: string): Promise<string> {
...
export async function generateKnowledgeExplanation(questionText: string): Promise<string> {
